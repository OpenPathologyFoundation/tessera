...
Thanks for improving WBC ΔΣ, the manual differential counter. This is a safety‑critical, clinical workflow tool, so changes must be careful, testable, and traceable.
