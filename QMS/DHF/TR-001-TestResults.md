...
**<!-- qms:fact tests_total -->1051<!-- /qms:fact --> tests ran across 3 verification layers and 3 browser engines, with 0 failures and <!-- qms:fact tests_skipped -->7<!-- /qms:fact --> documented skips.**

| Metric | Value |
|--------|-------|
| Unit, static and behavioural tests | **<!-- qms:fact tests_node -->655<!-- /qms:fact -->** |
| System (browser) tests | **<!-- qms:fact tests_browser -->396<!-- /qms:fact -->** (chromium, firefox, webkit) |
| **Total** | **<!-- qms:fact tests_total -->1051<!-- /qms:fact -->** |
...
`<!-- qms:fact evidence_run_id -->2026-08-07_081531_run<!-- /qms:fact -->`.
...
All <!-- qms:fact tests_total -->1051<!-- /qms:fact --> automated tests pass with no failures, across three browser
