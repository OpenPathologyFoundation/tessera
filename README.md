...
| E2E | `tests-e2e/*.spec.js` | **System** | The deployed application in Chromium, Firefox and WebKit — 140 specs x 3 engines |
...
| **TP-001** | Test plan; register of 744 implemented verification cases, generated from the runners |
