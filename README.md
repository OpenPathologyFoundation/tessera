...
| E2E | `tests-e2e/*.spec.js` | **System** | The deployed application in Chromium, Firefox and WebKit — 142 specs x 3 engines |
| **Total** | | | **<!-- qms:fact tests_total -->1092<!-- /qms:fact --> tests** (<!-- qms:fact tests_node -->672<!-- /qms:fact --> Node + <!-- qms:fact tests_browser -->420<!-- /qms:fact --> browser), of which <!-- qms:fact tests_skipped -->7<!-- /qms:fact --> are documented skips |
...
| **TP-001** | Test plan; register of 752 implemented verification cases, generated from the runners |
